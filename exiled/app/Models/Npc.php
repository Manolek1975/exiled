...
class Npc extends Model
{
    ...
    */
    ...
    protected $fillable = ['nombre', 'descripcion', 'imagen', 'location', 'area_id', 'quest_id', 'notas', 'title', 'slug'];
    //protected $casts = ['quests_id' => 'array'];
    // protected $hidden = [];
    // protected $dates = [];
    ...
    */
    ...
    public function quest(){
        return $this->belongsToMany('App\Models\Quest', 'quest_npc')->withPivot('npc_id');
    }    
    /*
    |--------------------------------------------------------------------------
    | SCOPES
