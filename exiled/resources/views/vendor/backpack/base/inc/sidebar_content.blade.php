...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('area') }}'><i class='nav-icon fa fa-question'></i> Areas</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('npc') }}'><i class='nav-icon fa fa-question'></i> Npcs</a></li>
