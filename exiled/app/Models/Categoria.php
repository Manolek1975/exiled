...
class Categoria extends Model
{
    ...
    */
    ...
    protected $fillable = ['grupo_id', 'nombre', 'descripcion', 'foto', 'slug'];
    // protected $hidden = [];
    // protected $dates = [];
    ...
    */
    public static function boot()
    {
        ...
        static::deleting(function($obj) {
            \Storage::disk('uploads')->delete($obj->foto);
        });
    ...
    */
    ...
    public function setFotoAttribute($value) //el nombre debe ser igual al del campo
    {
        $attribute_name = "foto";
        $disk = "uploads";
        $destination_path = "";
